...
Let us find the columns corresponding to pitch, roll and yaw:
```{r}
...
Now we increase the number of predictors to reduce the oob. We add the "roll" variables to the list as shown below and build the model using the training set:
```{r}
library(caret)
